...
- **SoC:** Broadcom BCM2712 — 4× ARM Cortex-A76 @ 2.4 GHz
- **RAM:** 4 GB or 8 GB LPDDR4X (get 4 GB minimum)
- **USB:** 2× USB 3.0 + 2× USB 2.0 (separate controllers per pair)
- **Connectivity:** Gigabit Ethernet, Wi-Fi 5, Bluetooth 5.0
- **GPIO:** 40-pin header with UART0 for GPS
- **Price:** ~$60 (4 GB), ~$80 (8 GB)

**Why it works well:**  The A76 cores are roughly 2–3× faster than the Pi 4's
...
at ~80°C — still adequate but leaves less headroom.
...
RSPduo's sustained 16 MB/s (2× 2 MSPS × 4 bytes × 2 channels) benefits from a
...
- **SoC:** Broadcom BCM2711 — 4× ARM Cortex-A72 @ 1.5–1.8 GHz
- **RAM:** 2 GB, 4 GB, or 8 GB LPDDR4
- **USB:** 2× USB 3.0 + 2× USB 2.0 (via VL805 hub chip on shared bus)
...
share one VL805 USB controller via PCIe × 1, so the RSPduo and a GPS USB adapter
...
- **SoC:** Rockchip RK3588S — 4× Cortex-A76 @ 2.4 GHz + 4× Cortex-A55 @ 1.8 GHz
- **RAM:** 4, 8, or 16 GB LPDDR5
- **USB:** 1× USB 3.0 (A or C depending on variant) + 2× USB 2.0
...
- **USB:** More ports (4× USB 3.0 on the Plus via hub)
...
- **SoC:** Amlogic S922X — 4× Cortex-A73 @ 2.4 GHz + 2× Cortex-A53 @ 2.0 GHz
- **RAM:** 4 GB LPDDR4
- **USB:** 4× USB 3.0 (separate controller from USB 2.0)
- **Price:** ~$80
...
- 4× Efficient Core Intel N100 @ up to 3.4 GHz — far more than needed
...
|----------|----------|------|----------|-------|
| **Hetzner** | CAX21 | 4 vCPU arm64, 8 GB RAM, 80 GB SSD | ~€4 | Best value; arm64 packages available |
| **Hetzner** | CX22 | 2 vCPU x86, 4 GB RAM, 40 GB SSD | ~€4 | Good value; x86 standard packages |
