...
class EventPairer:
    ...
    correlation_window_s :
        ...
        inter-node spread ~39 ms, giving a 2.5× safety margin).
    ...
    def _t_sync_ns(self, event: dict[str, Any]) -> int:
        ...
        different (older) pilot zero-crossing, offset by N × 7 ms.
        """
        dist_m = haversine_m(
    ...
    def _find_group(self, base_key: tuple, t_sync_ns: int, node_id: str) -> _Group | None:
        ...
        for grp in self._groups.values():
            ...
            # N×7 ms ahead will produce T_sync values offset by N×7 ms
